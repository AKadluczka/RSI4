...
namespace Klient12.ServiceReference1 {
    ...
    public interface IStrumien {
        ...
        Klient12.ServiceReference1.ResponseFileMessage getMStream(Klient12.ServiceReference1.RequestFileMessage request);
        ...
        Klient12.ServiceReference1.ResponseFileUpload UploadMStream(Klient12.ServiceReference1.RequestFileUpload request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStrumien/UploadMStream", ReplyAction="http://tempuri.org/IStrumien/UploadMStreamResponse")]
        System.Threading.Tasks.Task<Klient12.ServiceReference1.ResponseFileUpload> UploadMStreamAsync(Klient12.ServiceReference1.RequestFileUpload request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStrumienChannel : Klient12.ServiceReference1.IStrumien, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StrumienClient : System.ServiceModel.ClientBase<Klient12.ServiceReference1.IStrumien>, Klient12.ServiceReference1.IStrumien {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Klient12.ServiceReference1.ResponseFileMessage Klient12.ServiceReference1.IStrumien.getMStream(Klient12.ServiceReference1.RequestFileMessage request) {
        ...
        public string getMStream(string nazwa1, out long rozmiar, out System.IO.Stream dane) {
            ...
            Klient12.ServiceReference1.ResponseFileMessage retVal = ((Klient12.ServiceReference1.IStrumien)(this)).getMStream(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Klient12.ServiceReference1.ResponseFileMessage> Klient12.ServiceReference1.IStrumien.getMStreamAsync(Klient12.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStreamAsync(request);
        }
        
        public System.Threading.Tasks.Task<Klient12.ServiceReference1.ResponseFileMessage> getMStreamAsync(string nazwa1) {
            Klient12.ServiceReference1.RequestFileMessage inValue = new Klient12.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Klient12.ServiceReference1.ResponseFileUpload Klient12.ServiceReference1.IStrumien.UploadMStream(Klient12.ServiceReference1.RequestFileUpload request) {
            return base.Channel.UploadMStream(request);
        }
        
        public void UploadMStream(string nazwa, string opis, System.IO.Stream dane) {
            Klient12.ServiceReference1.RequestFileUpload inValue = new Klient12.ServiceReference1.RequestFileUpload();
            inValue.nazwa = nazwa;
            inValue.opis = opis;
            inValue.dane = dane;
            Klient12.ServiceReference1.ResponseFileUpload retVal = ((Klient12.ServiceReference1.IStrumien)(this)).UploadMStream(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Klient12.ServiceReference1.ResponseFileUpload> Klient12.ServiceReference1.IStrumien.UploadMStreamAsync(Klient12.ServiceReference1.RequestFileUpload request) {
            return base.Channel.UploadMStreamAsync(request);
        }
        
        public System.Threading.Tasks.Task<Klient12.ServiceReference1.ResponseFileUpload> UploadMStreamAsync(string nazwa, string opis, System.IO.Stream dane) {
            Klient12.ServiceReference1.RequestFileUpload inValue = new Klient12.ServiceReference1.RequestFileUpload();
            inValue.nazwa = nazwa;
            inValue.opis = opis;
            inValue.dane = dane;
            return ((Klient12.ServiceReference1.IStrumien)(this)).UploadMStreamAsync(inValue);
        }
