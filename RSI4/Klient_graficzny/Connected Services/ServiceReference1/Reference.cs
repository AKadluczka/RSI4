...
namespace Klient_graficzny.ServiceReference1 {
    ...
    public interface IStrumien {
        ...
        Klient_graficzny.ServiceReference1.ResponseFileMessage getMStream(Klient_graficzny.ServiceReference1.RequestFileMessage request);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStrumienChannel : Klient_graficzny.ServiceReference1.IStrumien, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StrumienClient : System.ServiceModel.ClientBase<Klient_graficzny.ServiceReference1.IStrumien>, Klient_graficzny.ServiceReference1.IStrumien {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Klient_graficzny.ServiceReference1.ResponseFileMessage Klient_graficzny.ServiceReference1.IStrumien.getMStream(Klient_graficzny.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStream(request);
        }
        
        public string getMStream(string nazwa1, out long rozmiar, out System.IO.Stream dane) {
            Klient_graficzny.ServiceReference1.RequestFileMessage inValue = new Klient_graficzny.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
            Klient_graficzny.ServiceReference1.ResponseFileMessage retVal = ((Klient_graficzny.ServiceReference1.IStrumien)(this)).getMStream(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Klient_graficzny.ServiceReference1.ResponseFileMessage> Klient_graficzny.ServiceReference1.IStrumien.getMStreamAsync(Klient_graficzny.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStreamAsync(request);
        }
        
        public System.Threading.Tasks.Task<Klient_graficzny.ServiceReference1.ResponseFileMessage> getMStreamAsync(string nazwa1) {
            Klient_graficzny.ServiceReference1.RequestFileMessage inValue = new Klient_graficzny.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
