...
namespace Klient.ServiceReference1 {
    ...
    public interface IStrumien {
        ...
        Klient.ServiceReference1.ResponseFileMessage getMStream(Klient.ServiceReference1.RequestFileMessage request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStrumien/getMStream", ReplyAction="http://tempuri.org/IStrumien/getMStreamResponse")]
        System.Threading.Tasks.Task<Klient.ServiceReference1.ResponseFileMessage> getMStreamAsync(Klient.ServiceReference1.RequestFileMessage request);
        ...
        Klient.ServiceReference1.DaneObrazkow[] Lista();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStrumien/Lista", ReplyAction="http://tempuri.org/IStrumien/ListaResponse")]
        System.Threading.Tasks.Task<Klient.ServiceReference1.DaneObrazkow[]> ListaAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStrumienChannel : Klient.ServiceReference1.IStrumien, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StrumienClient : System.ServiceModel.ClientBase<Klient.ServiceReference1.IStrumien>, Klient.ServiceReference1.IStrumien {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Klient.ServiceReference1.ResponseFileMessage Klient.ServiceReference1.IStrumien.getMStream(Klient.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStream(request);
        }
        
        public string getMStream(string nazwa1, out long rozmiar, out System.IO.Stream dane) {
            Klient.ServiceReference1.RequestFileMessage inValue = new Klient.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
            Klient.ServiceReference1.ResponseFileMessage retVal = ((Klient.ServiceReference1.IStrumien)(this)).getMStream(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Klient.ServiceReference1.ResponseFileMessage> Klient.ServiceReference1.IStrumien.getMStreamAsync(Klient.ServiceReference1.RequestFileMessage request) {
            return base.Channel.getMStreamAsync(request);
        }
        
        public System.Threading.Tasks.Task<Klient.ServiceReference1.ResponseFileMessage> getMStreamAsync(string nazwa1) {
            Klient.ServiceReference1.RequestFileMessage inValue = new Klient.ServiceReference1.RequestFileMessage();
            inValue.nazwa1 = nazwa1;
            return ((Klient.ServiceReference1.IStrumien)(this)).getMStreamAsync(inValue);
        }
        ...
        public Klient.ServiceReference1.DaneObrazkow[] Lista() {
            return base.Channel.Lista();
        }
        
        public System.Threading.Tasks.Task<Klient.ServiceReference1.DaneObrazkow[]> ListaAsync() {
